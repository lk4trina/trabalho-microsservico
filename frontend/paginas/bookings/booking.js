import { getRooms, createBookingRequest, getMyBookings, cancelBookingRequest } from "../../services/api.js";
...
window.openEditModal = function(booking) {
    ...
    document.getElementById("edit-room-name").innerText = `Sala: ${booking.roomName}`;
    
    
    document.getElementById("editStartTime").value = booking.startTime.slice(0, 16);
